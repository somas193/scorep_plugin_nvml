...
# Headers
file(GLOB nvml_header_path_hint /app/env/include /usr/include/nvidia*/include /usr/local/cuda*/include /opt/cuda*/include /usr/lib/*linux-gnu /usr/local/cuda*/targets/*/include)
...
if("${CMAKE_SIZEOF_VOID_P}" EQUAL "8") # 64bit
    file(GLOB nvml_lib_path_hint /app/env/lib/stubs/ /usr/lib64/nvidia*/ /usr/lib/nvidia*/ /usr/local/cuda*/targets/*/lib/stubs/)
else() # assume 32bit
    file(GLOB nvml_lib_path_hint /app/env/lib/stubs/ /usr/lib32/nvidia*/ /usr/lib/nvidia*/ /usr/local/cuda*/targets/*/lib/stubs/)
endif()
find_library(NVML_LIBRARIES NAMES nvidia-ml libnvidia-ml.so libnvidia-ml.so.1
